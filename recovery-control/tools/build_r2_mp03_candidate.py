...
def main() -> int:
    ...
    expected = {
        ...
        "src/watchers/fast_recovery_core/executor.py": args.v3_root / "src/watchers/fast_recovery_core/executor.py",
    }
        ...
        "\n".join(
            [
                ...
                *copy_lines,
                ...
                "    MAINTENANCE_AUDIT_PROJECTION_HIGH_WATER_FILE=/state/p1-audit/mp03/projection-high-water.json \\",
    ...
    manifest = {
        "schema_version": "recovery_control.r2_mp03_candidate.v1",
        ...
        "snapshot_projection": {
            ...
            "source_producer_id": "arena-maintenance-shadow",
            "consumer_write_credential_required": False,
        },
        "effect_boundary": "before_signal callback immediately before os.kill-compatible send_signal",
        "in_flight_truth": "PROPOSED_NOT_DURABLE",
        "native_generation_mapping": "MISSING",

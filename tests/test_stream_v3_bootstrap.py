...
class StreamV3BootstrapTests(unittest.TestCase):
    ...
    def test_k3s_shadow_manifests_exist_and_stay_test_mode(self) -> None:
        ...
        self.assertIn("VIDEO_QUEUE_SIZE: \"32\"", configmap)
        ...
        self.assertIn("volume=0.540680", configmap)
        self.assertIn("PULSE_SERVER: unix:/run/stream-pulse/native", configmap)
        self.assertIn("AUTO_DJ_KEEP_PULSE_SERVER: \"1\"", configmap)
        self.assertIn("AUTO_DJ_NCS_GAIN_DB: \"-6.7\"", configmap)
        self.assertIn("AUTO_DJ_FLORACORE_GAIN_DB: \"0\"", configmap)
        ...
        self.assertIn("FR_GPU_PREFLIGHT_ENABLED: \"1\"", configmap)
        self.assertIn("FR_GPU_PREFLIGHT_CONTAINER: stream-engine", configmap)
        ...
        self.assertIn("fonts-noto-cjk \\", containerfile)
        self.assertIn("fonts-noto-core \\", containerfile)
        self.assertIn("fonts-noto-color-emoji \\", containerfile)

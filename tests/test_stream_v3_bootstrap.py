...
class StreamV3BootstrapTests(unittest.TestCase):
    ...
    def test_k3s_shadow_manifests_exist_and_stay_test_mode(self) -> None:
        ...
        self.assertIn("VIDEO_NVENC_PRESET: p5", configmap)
        self.assertIn("VIDEO_NVENC_RC: cbr", configmap)
        self.assertIn("VIDEO_NVENC_CQ: \"\"", configmap)
        self.assertIn("VIDEO_NVENC_MULTIPASS: fullres", configmap)
        self.assertIn("VIDEO_NVENC_RC_LOOKAHEAD: \"20\"", configmap)
        self.assertIn("VIDEO_NVENC_SPATIAL_AQ: \"1\"", configmap)
        self.assertIn("VIDEO_NVENC_TEMPORAL_AQ: \"1\"", configmap)
        self.assertIn("VIDEO_NVENC_BFRAMES: \"2\"", configmap)
        self.assertIn("VIDEO_NVENC_B_REF_MODE: middle", configmap)
        self.assertIn("FRAME_RATE: \"30\"", configmap)
        self.assertIn("VIDEO_BITRATE: 3300k", configmap)
        self.assertIn("VIDEO_MAXRATE: 3300k", configmap)
        self.assertIn("VIDEO_BUFSIZE: 6600k", configmap)

...
| How are ADS-B publication, map data, weather, and NCS attribution treated as design boundaries? | `src/stream_core/overlay_server.py`, `ui/overlay/index.html`, `ui/overlay/adsb-map/ATTRIBUTION.md`, `.gitignore` | `tests/test_overlay_server_outline.py`, `tests/test_adsb_map_contract.py`, `tests/test_docs_structure.py` | `docs/compliance-and-licensing-boundary.md`, `docs/security-and-secrets.md`, `docs/public-release.md` |

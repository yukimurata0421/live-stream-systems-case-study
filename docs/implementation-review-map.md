...
| How does the custom map prove render readiness? | `ui/overlay/adsb-map/*`, `src/stream_core/overlay_server.py`, `src/stream_core/engine/rendering_boot.py`, `src/stream_core/precipitation_fetcher.py` | `tests/test_adsb_map_contract.py`, `tests/test_overlay_precipitation_state.py`, `tests/test_precipitation_fetcher.py`, `tests/test_stream_engine_wait_modes.py` | `docs/v3/map-rendering-and-monitoring.md`, `ui/overlay/adsb-map/ATTRIBUTION.md` |

...
| Compliance and licensing boundary | Documented | `docs/compliance-and-licensing-boundary.md`, `docs/security-and-secrets.md`, `docs/public-release.md` | This is an operator risk posture and re-review checklist, not legal advice; laws, platform rules, and music-license terms can change. |
